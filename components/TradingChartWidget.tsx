...
import { getMockStockData, getMockTradeSignals, getMockRLPerformance } from '../services/marketDataService.ts';
import type { StockDataPoint, TradeSignal, RLAgentPerformance } from '../types.ts';
